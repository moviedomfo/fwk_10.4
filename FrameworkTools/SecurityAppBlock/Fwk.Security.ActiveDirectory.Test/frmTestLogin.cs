...
namespace Fwk.Security.ActiveDirectory.Test
{
    public partial class frmTestLogin : Form
    {
        ...
        private void btnCheck_Click(object sender, EventArgs e)
        {
            ...
            //    lblCheckResult.Text = ADWrapper.User_CheckLogin(txtDomain.Text, txtLoginName.Text, txtPassword.Text).ToString();
            //else
            //    lblCheckResult.Text = ADWrapper.User_CheckLogin(cmbAllDomains.Text, txtLoginName.Text, txtPassword.Text).ToString();
