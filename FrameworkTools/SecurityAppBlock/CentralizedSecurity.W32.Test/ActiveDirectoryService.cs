...
namespace Fwk.CentralizedSecurity.Service
{
    public class ActiveDirectoryService
    {
        ...
        internal static Fwk.CentralizedSecurity.Contracts.DomainsUrl[] GetAllDomainsUrl()
        {
            ...
            List<Fwk.Security.ActiveDirectory.DomainUrlInfo> auxlist = ADWrapper.DomainsUrl_GetList2(System.Configuration.ConfigurationManager.ConnectionStrings[ActiveDirectoryService.CnnStringName].ConnectionString);
