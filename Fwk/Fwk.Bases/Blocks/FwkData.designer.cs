...
namespace Fwk.ConfigData
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="Epiron3GMultilenguajeGestion")]
    ...
    partial void Deletefwk_ServiceAudit(fwk_ServiceAudit instance);
		...
		public System.Data.Linq.Table<fwk_ServiceAudit> fwk_ServiceAudit
		{
			get
			{
    ...
    partial void OnLogtypeChanging(string value);
    partial void OnLogtypeChanged();
    partial void OnRequetsTextChanging(string value);
    partial void OnRequetsTextChanged();
    ...
    partial void OnResponseTextChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RequetsText", DbType="VarChar(MAX)")]
		public string RequetsText
		{
			get
			{
				return this._RequetsText;
			}
			set
			{
				if ((this._RequetsText != value))
				{
					this.OnRequetsTextChanging(value);
					this.SendPropertyChanging();
					this._RequetsText = value;
					this.SendPropertyChanged("RequetsText");
					this.OnRequetsTextChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ResponseText", DbType="VarChar(MAX)")]
